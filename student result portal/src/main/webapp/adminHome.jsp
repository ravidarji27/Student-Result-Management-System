...
<center><img src="ldce.jpeg" width="100" height="100">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="addNewStudent.jsp" method="post">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">Branch Name</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Division</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Enrollment Number</label>
                                    <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Theory of Computation</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Microprocessor & Interfacing</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Data Visulization</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Internet of Things.</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Object Oriented Pro.</label>
                                    <div class="col-md-6">
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          ...
          <th>Microprocessor & Interfacing</th>
          <th>Data Visualization</th>
          <th>Internet of Things</th>
          <th>Operating System</th>
          <th>Object Oriented Pro.</th>
        </tr>
      </thead>
    </table>
  </div>
...
{}%>
    ...
    <hr class="new1">
  <center><h5>Note: Institution doesn't own for the errors or omissions, if any, in this statement.
Designed & Developed by Darji & Dalsaniya Team</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ Darji & Dalsaniya :: 2022-2026</h5></center> 
  <hr class="new1">
<br>
</body>
</html>